...
import { Flame, TrendingUp, Copy, Check, CheckCircle2, Circle, Users, Plus, Sparkles, Trophy } from "lucide-react";
...
export default function TodayPage() {
  ...
  return (
    <DashboardLayout>
      ...
      <div className="space-y-3 pb-18 pt-2 px-1">
        {/* Section 1: Compact Stats Grid */}
        <div className="grid grid-cols-2 gap-2">
          {/* Daily Habits Card - Compact */}
          <div className="bg-gradient-to-r from-green-100 to-white p-3 rounded-lg shadow-sm border border-green-200/50">
            <div className="flex items-center gap-2">
              <div className="p-1.5 bg-green-500 rounded-md">
                <TrendingUp className="h-3.5 w-3.5 text-white" />
              </div>
              <div className="flex-1 min-w-0">
                <h3 className="font-medium text-gray-900 text-xs truncate">Daily Habits</h3>
          ...
          {/* Active Streaks Card - Compact */}
          <div className="bg-gradient-to-r from-orange-100 to-white p-3 rounded-lg shadow-sm border border-orange-200/50">
            <div className="flex items-center gap-2">
              <div className="p-1.5 bg-orange-500 rounded-md">
                <Flame className="h-3.5 w-3.5 text-white" />
              </div>
              <div className="flex-1 min-w-0">
                <h3 className="font-medium text-gray-900 text-xs truncate">Streaks</h3>
        ...
        {/* Section 2: Today's Habits List */}
        <div className="space-y-3">
          <h2 className="text-lg font-semibold text-gray-900 px-1">Today's Habits</h2>
        ...
        {convexUser?._id && (
          <div className="fixed bottom-16 left-0 right-0 p-4 bg-white/80 backdrop-blur-sm border-t border-gray-200">
            ...
            >
              <Button 
                size="lg" 
                className="w-full bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white shadow-lg rounded-full py-3 font-medium"
              >
